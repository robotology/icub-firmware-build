...
|:----------------------------------------------------------------------------:|:---------------------:|:-------:|
| `v2026.08.0`                                                                   | `v1.46.0`             |  [`info/firmware.info.xml`](https://github.com/robotology/icub-firmware-build/blob/v1.46.0/info/firmware.info.xml) |
| `v2025.11.1`                                                                   | `v1.45.1`             |  [`info/firmware.info.xml`](https://github.com/robotology/icub-firmware-build/blob/v1.45.1/info/firmware.info.xml) |
| `v2025.11.0`                                                                   | `v1.45.0`             |  [`info/firmware.info.xml`](https://github.com/robotology/icub-firmware-build/blob/v1.45.0/info/firmware.info.xml) |
| `v2025.08.0`                                                                   | `v1.44.0`             |  [`info/firmware.info.xml`](https://github.com/robotology/icub-firmware-build/blob/v1.44.0/info/firmware.info.xml) |
| `v2025.05.0`                                                                   | `v1.43.0`             |  [`info/firmware.info.xml`](https://github.com/robotology/icub-firmware-build/blob/v1.43.0/info/firmware.info.xml) |
