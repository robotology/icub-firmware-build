...
ECHO Programming loader with %Programmer% (use command line option "-help" to see how to change programmer)
...
rem section for loader
mkdir reports
copy ..\bin\environment\mc2plusLoader.hex reports
copy reports\mc2plusLoader.hex tools\target.hex 
C:\Keil_v5\UV4\UV4 -f tools\burn_target.uvprojx -o ..\reports\mc2plusLoader_burn_report.txt -t %target%
del /F tools\*.bak
del /F tools\*.dep
del /F tools\*.plg
del /F tools\*.uvgui*
