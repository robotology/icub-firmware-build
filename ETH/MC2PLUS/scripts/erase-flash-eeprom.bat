...
mkdir reports
copy ..\bin\environment\mc2plusEEPROMerase.hex reports
copy reports\mc2plusEEPROMerase.hex tools\target.hex 
C:\Keil_v5\UV4\UV4 -f tools\burn_target.uvprojx -o ..\reports\mc2plusEEPROMerase_burn_report.txt -t %target%
del /F tools\*.bak
del /F tools\*.dep
del /F tools\*.plg
del /F tools\*.uvgui*
